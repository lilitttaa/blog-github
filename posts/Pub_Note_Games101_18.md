...
因为你的这个这个pass tracing里面的第一个bce是def
...
然后呢他现在你这又找了一堆这个从这个camera触发了一堆光线
...
这些函数允许你这个得到一些很神奇的一些noise

比如说看起来像木头纹理的这个noise啊
...
![01-33-39](tmp/01-33-39.jpg)

那咱们之后把这个时间交还给技术这秘书同学
