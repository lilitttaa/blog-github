...
那这样的话这个小写x和小写y都是这个大写x和大写z的这个函数
...
就是因为大家可以看到c m y可以通过混合得到各种各样不同的颜色
...
就这意思就是说我们之前在做ptron的时候问过这

么一个问题说你算出来的最后是pixel radiance
...
然后呢这边有同学问d65 和d50 这块我就不再多提了

这仅仅是相当于有不同的光源

就说第d65 有一种有一种什么样的这种灯
