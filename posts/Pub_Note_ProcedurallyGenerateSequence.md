...
- Dialogue Editor
- 介绍整个生成过程
- 后期编辑，如何处理自动生成-》手动编辑器-》再次生成的问题，并且不丢失之前的编辑内容
- 一些 Sequencer 的陷阱
...
- 每个相机切换至少 2.5 秒，最多 9 秒，因此如果句子很短，它们将共享相同的相机镜头，否则看起来会非常机器人化。
...
- 基本上，我们有两种类型的动画
  - 标准姿势：基本上只是 Idle，动作很少，因为我们在其上添加了很多附加动画。
  - 叠加手势，有两种类型：
